...
<!-- expand_section("Aprofunde-se na definição de Processos Autoregressivos") -->
...
<!-- create_image("Um conjunto de gráficos que exemplifica os conceitos tratados no texto com foco na definição de modelo auto regressivo") -->
