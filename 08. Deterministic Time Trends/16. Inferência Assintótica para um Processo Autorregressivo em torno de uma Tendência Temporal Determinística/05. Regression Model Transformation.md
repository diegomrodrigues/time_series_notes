...
$$\frac{\partial \ell(\theta)}{\partial \sigma^2} = -\frac{1}{2} \text{tr}\left(Q^{-1} \frac{\partial Q}{\partial \sigma^2}\right) - \frac{1}{2} Y^T \left( - Q^{-1} \frac{\partial Q}{\partial \sigma^2} Q^{-1} \right) Y$$
